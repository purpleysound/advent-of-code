...
# probs will be a repeating pattern as step count increases in these multiples of 131
...
print(15075*202300**2 + 15114*202300 + 3787) # works bc i did 63 steps previous instead of 64, got off by 1 error last time but this time it was special